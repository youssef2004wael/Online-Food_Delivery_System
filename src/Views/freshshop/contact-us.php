            ...
            <div class="row">
                <div class="col-lg-8 col-sm-12">
                    <div class="contact-form-right">
                        ...
                        <form id="contactForm" action="./php/form-process.php" method="post" >
                            <div class="row">
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="Subject1" name="Subject1" placeholder="Subject" required data-error="Please enter your Subject">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <textarea class="form-control" id="info" placeholder="Your Message" rows="4" data-error="Write your message" required name="msg" ></textarea>
                                        <div class="help-block with-errors"></div>
                                    </div>
